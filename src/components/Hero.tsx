  ...
  return (
    <>
      ...
      <section className="min-h-screen bg-black flex flex-col relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col justify-end items-center pb-24 pt-96 relative z-10">
          <div className="text-center px-6 max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight leading-none">
              <span className="bg-gradient-to-r from-foreground via-foreground to-muted-foreground bg-clip-text text-transparent">
                FORGED FINANCE
              </span>
            </h1>
            
            <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground mb-16 leading-relaxed font-light max-w-3xl mx-auto">
      ...
      {/* Second Page Content - Split Layout */}
      ...
      {/* Trusted by Business Schools Section */}
      <section className="py-20 bg-black border-t border-border/20">
